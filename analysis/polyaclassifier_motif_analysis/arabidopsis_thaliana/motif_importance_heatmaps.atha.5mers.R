...
t_rich <- c('AATTT', 'ACTTT', 'AGTTT', 'ATATT', 'ATCTT', 'ATGTT', 'ATTAT', 'ATTCT', 'ATTGT', 'ATTTA', 'ATTTC', 'ATTTG', 'ATTTT', 'CATTT',
            'CCTTT', 'CGTTT', 'CTATT', 'CTCTT', 'CTGTT', 'CTTAT', 'CTTCT', 'CTTGT', 'CTTTA', 'CTTTC', 'CTTTG', 'CTTTT', 'GATTT', 'GCTTT',
            'GGTTT', 'GTATT', 'GTCTT', 'GTGTT', 'GTTAT', 'GTTCT', 'GTTGT', 'GTTTA', 'GTTTC', 'GTTTG', 'GTTTT', 'TAATT', 'TACTT', 'TAGTT',
            'TATAT', 'TATCT', 'TATGT', 'TATTA', 'TATTC', 'TATTG', 'TATTT', 'TCATT', 'TCCTT', 'TCGTT', 'TCTAT', 'TCTCT', 'TCTGT', 'TCTTA',
            'TCTTC', 'TCTTG', 'TCTTT', 'TGATT', 'TGCTT', 'TGGTT', 'TGTCT', 'TGTGT', 'TGTTA', 'TGTTC', 'TGTTG', 'TGTTT', 'TTAAT', 'TTACT',
            'TTAGT', 'TTATA', 'TTATC', 'TTATG', 'TTATT', 'TTCAT', 'TTCCT', 'TTCGT', 'TTCTA', 'TTCTC', 'TTCTG', 'TTCTT', 'TTGAT', 'TTGCT',
            'TTGGT', 'TTGTC', 'TTGTG', 'TTGTT', 'TTTAA', 'TTTAC', 'TTTAG', 'TTTAT', 'TTTCA', 'TTTCC', 'TTTCG', 'TTTCT', 'TTTGA', 'TTTGC',
            'TTTGG', 'TTTGT', 'TTTTA', 'TTTTC', 'TTTTG', 'TTTTT')

a_rich <- c('AAAAA', 'AAAAC', 'AAAAG', 'AAAAT', 'AAACA', 'AAACC', 'AAACG', 'AAACT', 'AAAGA', 'AAAGC', 'AAAGG', 'AAAGT', 'AAATA', 'AAATC',
            'AAATG', 'AAATT', 'AACAA', 'AACAC', 'AACAG', 'AACAT', 'AACCA', 'AACGA', 'AACTA', 'AAGAA', 'AAGAC', 'AAGAG', 'AAGAT', 'AAGCA',
            'AAGGA', 'AAGTA', 'AATAA', 'AATAC', 'AATAG', 'AATAT', 'AATCA', 'AATGA', 'AATTA', 'ACAAA', 'ACAAC', 'ACAAG', 'ACAAT', 'ACACA',
            'ACAGA', 'ACATA', 'ACCAA', 'ACGAA', 'ACTAA', 'AGAAA', 'AGAAC', 'AGAAG', 'AGAAT', 'AGACA', 'AGAGA', 'AGATA', 'AGCAA', 'AGGAA',
            'AGTAA', 'ATAAA', 'ATAAC', 'ATAAG', 'ATAAT', 'ATACA', 'ATAGA', 'ATATA', 'ATCAA', 'ATGAA', 'ATTAA', 'CAAAA', 'CAAAC', 'CAAAG',
            'CAAAT', 'CAACA', 'CAAGA', 'CAATA', 'CACAA', 'CAGAA', 'CATAA', 'CCAAA', 'CGAAA', 'CTAAA', 'GAAAA', 'GAAAC', 'GAAAG', 'GAAAT',
            'GAACA', 'GAAGA', 'GAATA', 'GACAA', 'GAGAA', 'GATAA', 'GCAAA', 'GGAAA', 'GTAAA', 'TAAAA', 'TAAAC', 'TAAAG', 'TAAAT', 'TAACA',
            'TAAGA', 'TAATA', 'TACAA', 'TAGAA', 'TATAA', 'TCAAA', 'TGAAA', 'TTAAA')

tgta_rich <- c('ATGTA', 'CTGTA', 'GTGTA', 'TGTAA', 'TGTAC', 'TGTAG', 'TGTAT', 'TTGTA')

dt_atha <- read_delim("./analysis/polyaclassifier_motif_importance_heatmaps/hmdf_sum.arabidopsis_thaliana.polyaclassifier_bagging3_kmers-5.txt", delim = "\t")
...
ggsave("./analysis/polyaclassifier_motif_importance_heatmaps/atha.5mers.hm_correlation.svg", plot = g2, device = svg())
...
ggsave("./analysis/polyaclassifier_motif_importance_heatmaps/atha.5mers.hm_importance.reordered.svg", plot = g3, device = svg())
